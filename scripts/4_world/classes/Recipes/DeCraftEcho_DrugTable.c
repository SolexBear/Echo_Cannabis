class  DeCraftEcho_DrugTable extends RecipeBase
{	
	override void Init()
	{
		m_Name = "#dismantle";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Echo_DrugTable");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Echo_DrugTable_Kit");//add results here
